...
public class Main {
   ...
   /* private final static UserService userService = new UserServiceImpl();
    ...
    public static void main(String[] args) throws SQLException {
        ...
        userDao.saveUser("Alexandr", "Ponomariov", (byte) 33);
        userDao.saveUser("Vladimir", "Aronov", (byte) 21);
        userDao.saveUser("Irina", "Romanova", (byte) 50);
        userDao.saveUser("Anatoly", "Ivanov", (byte) 39);
